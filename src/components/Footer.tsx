				...
				<div className={"hidden xl:grid xl:grid-cols-3 justify-end xl:gap-8 py-12 lg:py-14"}>
					<div className={"space-y-8"}>
						<Flex justifyContent={"center"} className={"gap-3 sm:justify-start"}>
							...
							<Metric className={"text-xl text-white whitespace-nowrap"}>Litmobile</Metric>
							<Badge className={"bg-tremor-brand text-tremor-brand-inverted font-medium hidden sm:block"}>Beta</Badge>
						</Flex>
